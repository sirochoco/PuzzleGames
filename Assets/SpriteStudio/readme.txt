==================================================================
SpriteStudioPlayer for Unity3D とは SpriteStudio で作成された
アニメーションデータを、Unity3D 上で表示・制御するためのプラグインです。

詳しくはSpriteStudio/Documents/Japanese/ 内のreadme.txt をお読みください。
==================================================================

SpriteStudioPlayer for Unity3D is a tool to create 2d animation data and
...
* Can be used together with other 3D assets in Unity3D
...
SpriteStudioPlayer for Unity3D or SpriteStudio.

SpriteStudioPlayer for Unity3D Introduction Video
http://www.youtube.com/watch?feature=player_embedded&v=l5ywNeVm2Gc

SpriteStudioPlayer for Unity3D Asset Information
